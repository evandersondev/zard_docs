...
const PERF_DATA = [
  { name: "Zard",   small: 0.93,  complex: 7.3,  note: "Native Dart", highlight: true  },
  { name: "Zod",    small: 0.13,  complex: 1.3,  note: "JS engine",   highlight: false },
  { name: "Yup",    small: 5.7,   complex: 66,   note: "Reference",   highlight: false },
];
